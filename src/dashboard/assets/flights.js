(() => {
  ...
  // El panel nunca debe quedar más bajo que el mapa (para que no se vea un
  // hueco junto a un mapa alto con pocas rutas), pero tampoco debe recortar
  // su contenido cuando hay muchas rutas: por eso solo se fija un alto
  // mínimo, nunca un alto máximo -- un máximo obligaría a un scroll interno
  // propio o, sin él, a que el contenido se salga visualmente del panel.
