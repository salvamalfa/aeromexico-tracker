...
PIPELINE_STEPS: tuple[PipelineStep, ...] = (
    ...
    PipelineStep("transform.validate_silver", PipelinePhase.TRANSFORM, "Validate all 29 Silver contracts, grains, domains, lineage fields, and relationships", "src.transform.silver_contracts:run_silver_contract_validation", REQUIRED, (files("Complete Silver layer", "data/silver/*.parquet"),), ("data/quality/stage9_silver_contracts.json",), depends_on=("transform.validate_stage4", "transform.validate_stage5", "parse.bmv", "parse.aeromexico_ir")),
