...
PIPELINE_STEPS: tuple[PipelineStep, ...] = (
    ...
    PipelineStep("ingest.aeromexico_ir", PipelinePhase.INGEST, "Official Aeromexico quarterly earnings releases", "src.ingest.aeromexico_ir:run", OPTIONAL, (), ("data/bronze/_manifest.jsonl",), network_required=True),
    ...
    PipelineStep("parse.aeromexico_ir", PipelinePhase.PARSE, "Official quarterly operating metrics into typed Silver facts", "src.parse.aeromexico_ir:run", OPTIONAL, (bronze("Aeromexico IR quarterly releases", "aeromexico_ir"),), ("data/silver/aeromexico_ir_quarterly_metrics.parquet",)),
    PipelineStep("parse.aeromexico_ir_financial", PipelinePhase.PARSE, "Historical financial evidence with original units and page locators", "src.parse.aeromexico_ir_financial:run", OPTIONAL, (bronze("Aeromexico IR quarterly releases", "aeromexico_ir"),), ("data/silver/aeromexico_ir_financial_history.parquet", "data/silver/aeromexico_ir_financial_gaps.json")),
