...
| P4a | Front-end en archivos reales: vista Vuelos en `web/` con ES modules y paridad (fase 3) | en curso | | subagente migrador trabajando |
| P4b | Front-end en archivos reales: lectura ejecutiva y demás pestañas (fase 3) | pendiente | | |
